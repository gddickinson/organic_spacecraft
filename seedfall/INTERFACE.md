...
Every system is drawn from the design documents: the hull classes from the Fleet
Class Reference, the six-layer hull from the Design Dossier, the phosphorus
bottleneck and 9:1 ore ratio from Metabolism, the wet/dry cyborg control stack
from Nervous System, the cell types from the Cell Atlas, and the
reproduction-licence containment regime from the Fleet Registry.
...
│   ├── chassis.py      21 hull chassis + the three layer-stack templates
...
│   ├── tech.py         58-node research tree, 10 branches, 5 tiers
│   ├── colonies.py     12 colony classes
