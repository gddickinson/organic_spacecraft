...
# What a posting costs to source and what the card quotes live in
# `sim/contract_price.py` (split out at 500 lines); re-exported so
# `contracts.quote` stays the one door every screen and check asks.
from .contract_price import (CARGO_KINDS, CARGO_MARGIN,  # noqa: E402,F401
                             HAULAGE, cargo_cost, quote)
