...
Contents (180 modules; one line each in `INTERFACE.md`):
...
Everything else: afoot_marks, beginning_path, craft_panel, craft_window,
    craft_yard, port_services, worldmap_view, zone_canvas."""
